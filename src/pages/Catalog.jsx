...
function Catalog() {
    ...
    console.log("cpd", catalogPageData);
    ...
    return (
        <>
            ...
            {/* Section 2 */}
            <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
                <div className="section_heading text-richblack-300">
                    Top courses in <span className="text-ye">{catalogPageData?.data?.differentCategories[0]?.name}</span>
                </div>
                <div className="py-8">
                    <Course_Slider
                        Courses={catalogPageData?.data?.differentCategories[0]?.courses ? catalogPageData?.data?.differentCategories[0]?.courses : []}
                    />
                </div>
            </div>
